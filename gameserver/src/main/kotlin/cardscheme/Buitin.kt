...
fun injectBuiltin(environment: Environment) {
    ...
    environment.put("max", NativeFuncValue("max", Arity(1, Int.MAX_VALUE), ::builtinMax))
    environment.put("min", NativeFuncValue("min", Arity(1, Int.MAX_VALUE), ::builtinMin))

    environment.put("zero?", NativeFuncValue("zero?", Arity(1, 1), ::builtinIsZero))
    environment.put("positive?", NativeFuncValue("positive?", Arity(1, 1), ::builtinIsPositive))
    environment.put("negative?", NativeFuncValue("negative?", Arity(1, 1), ::builtinIsNegative))
    environment.put("odd?", NativeFuncValue("odd?", Arity(1, 1), ::builtinIsOdd))
    environment.put("even?", NativeFuncValue("even?", Arity(1, 1), ::builtinIsEven))
    environment.put("=", NativeFuncValue("=", Arity(2, Int.MAX_VALUE), ::builtinNumericalEqual))
    ...
    environment.put("equal?", NativeFuncValue("equal?", Arity(2, Int.MAX_VALUE), ::builtinIsEqual))
    ...
    environment.put("pair?", NativeFuncValue("pair?", Arity(1, 1), ::builtinIsPair))
    environment.put("null?", NativeFuncValue("null?", Arity(1, 1), ::builtinIsNull))
    ...
    environment.put("set-car!", NativeFuncValue("set-car!", Arity(2, 2), ::builtinSetCar))
    environment.put("set-cdr!", NativeFuncValue("set-cdr!", Arity(2, 2), ::builtinSetCdr))
    ...
    environment.put("reverse", NativeFuncValue("reverse", Arity(1, 1), ::builtInReverse))
    environment.put("assoc", NativeFuncValue("assoc", Arity(2, 3), ::builtInAssoc))

    environment.put("apply", NativeFuncValue("apply", Arity(2, Int.MAX_VALUE), ::builtinApply))
    ...
    environment.put("string?", NativeFuncValue("string?", Arity(1, 1), ::builtinIsString))
    environment.put(
        "string-append",
        NativeFuncValue("string-append", Arity(0, Int.MAX_VALUE), ::builtinStringAppend),
    )
