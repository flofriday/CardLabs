...
def test_delete_bot_from_editor(driver_headless):
    ...
    WebDriverWait(driver, 30).until(lambda driver: driver.find_element(By.CSS_SELECTOR, ".pt-14 > div").text == "Bot Overview")
    assert driver.find_element(By.CSS_SELECTOR, ".pt-14 > div").text == "Bot Overview"
