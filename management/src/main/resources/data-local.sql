...
VALUES
    ...
    (10007, 'Raxtron', 10000, '', 1000, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10008, 'Neophis', 10000, '', 1050, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10009, 'Raxmekos', 10000, '', 1100, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10010, 'Kryax', 10000, '', 1150, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10011, 'Zartartron', 10000, '', 1200, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10012, 'Vexdorium', 10000, '', 1250, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10013, 'Vextarax', 10000, '', 1400, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10014, 'Xennixos', 10000, '', 1950, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10015, 'Raxtareon', 10000, '', 2000, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10016, 'Xenphotron', 10000, '', 2500, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10017, 'Krytarphis', 10000, '', 2550, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    (10018, 'Krylonphis', 10000, '', 2600, 'QUEUED', 'READY', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
